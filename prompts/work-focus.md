...
```text
Set {{SOURCE_ID}} to work:focus and {{WORKER_ID}} to work-focus-daily.

Review user-owned work from approved task and code-review metadata. Prioritize current, startable work over a complete project inventory.
