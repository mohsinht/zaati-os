...
- Provider-neutral snapshot and safe presentation contracts.
- Adaptive React dashboard using shadcn conventions, Tailwind semantic tokens, and audited chart components.
- Synthetic demo snapshots for agenda, inbox, work, money, news, daily overview, and weekly review.
- Starter LLM prompts and deterministic worker ownership rules.
