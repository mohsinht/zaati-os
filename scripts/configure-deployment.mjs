...
if (!hostname || !/^(?=.{4,253}$)(?:[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?\.)+[a-z]{2,63}$/.test(hostname))
  throw new Error("ZAATI_HOSTNAME must be a valid custom hostname.")
if (!workerName || !/^[a-z0-9][a-z0-9-]{1,61}[a-z0-9]$/.test(workerName))
  throw new Error("ZAATI_WORKER_NAME must be a 3 to 63 character lowercase slug.")
